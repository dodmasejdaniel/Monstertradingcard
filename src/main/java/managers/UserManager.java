...
public class UserManager {
    ...
    //kjo shef nqs tokeni esht i sakt (tokeni esht 1 lloj passwordi q shifet vtm nga pc dhe useri n esht n dijeni te tij)
...
// kjo regjistron 1 user t ri n database
